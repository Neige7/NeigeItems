                        ...
                        BukkitScheduler["runTaskAsynchronously(Plugin,Runnable)"](Tool.getPlugin("Pouvoir"), function() {
                            ...
                            if (args.length == 1 || incrementingArray_NI(pageAmount).indexOf(args[1]) != -1) {
                                ...
                                for (let index = prevItemAmount; index < prevItemAmount + listItemAmount; index++) {
                                    ...
                                    // 构建信息及物品
                                    if (sender instanceof Player) {
                                        let itemStack = neigeItemManager.getItemStack(NeigeItemsData.itemIDList[index], sender, sender)
                                        ...
                                        try {
                                            ...
                                            let itemKeySection = neigeItemManager.getConfig(NeigeItemsData.itemIDList[index])
                                            let itemName = ""
...
function loadClass_NI() {
    ...
    NeigeItemManager = function() {
        ...
        this.loadItems()
        this.itemIds = new ArrayList(this.items.keySet())
    }
    ...
    NeigeItemManager.prototype.loadItems = function() {
        ...
        for (let index = 0; index < this.files.length; index++) {
            ...
            ids.forEach(function(id) {
                items[id] = new NeigeItem(file, id)
                // 下面是错误示例: 
